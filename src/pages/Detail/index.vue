        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <a @click="goAddCart" style="cursor: pointer"> 加入购物车 </a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    async goAddCart() {
      try {
        // await this.$store.dispatch("getAddCart", {
  ...
  mounted() {
    this.$store.dispatch("getItemDetail", this.$route.params.skuId);
  },
  computed: {
